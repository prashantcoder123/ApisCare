...
//           <div
//             key={index}
//             className="bg-red-50 px-4 py-3 rounded-md shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between"
//           >
//             <p className="text-sm font-semibold text-gray-700">{item.label}</p>
//             <p className={`text-base font-medium mt-1 sm:mt-0 ${item.color || "text-black"}`}>
//               {item.value}
//             </p>
//           </div>
//         ))}
